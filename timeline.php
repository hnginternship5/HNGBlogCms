...
$_SESSION['accesstoken'] = true;
            if(isset($_SESSION['accesstoken'])){
  try{
>>>>>>> 8832ab62f99210a4f43d8e68db4be9c734749909
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row d-flex flex-column post-section">
                        <!-- <textarea contentEditable="true" class="post-input" id="textArea" type="text" name="post-input" placeholder="What’s happening?"></textarea> -->
                        <div class="post-input" contentEditable="true">
                            What's happening?
                        </div>
                        <div class="row mx-0 d-flex flex-row mt-auto justify-content-between">
                            <div class="post-action-right" id="textAreaBtn">
